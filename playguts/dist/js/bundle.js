...
var GameCtrl = (function () {
    function GameCtrl($scope, $timeout, $window) {
        _classCallCheck(this, GameCtrl);

        Object.assign(this, { $scope: $scope, $timeout: $timeout });
    ...
    _createClass(GameCtrl, [{
        ...
        value: function _setupTimer() {
            ...
            this._timestamp = 'performance' in window && window.performance.now ? function () {
        ...
        value: function loop() {
            ...
            this._timer = this.$timeout(function () {
                ...
                var now = _this._timestamp(),
                    delta = now - _this._lastLoop;
                _this._lastLoop = now;
                _this._floatEpoch += delta;

                _this.state.epoch = Math.floor(_this._floatEpoch);

                // Next iteration
                _this._timer = _this.$timeout(function () {
                    return _this.loop();
                }, 0);
